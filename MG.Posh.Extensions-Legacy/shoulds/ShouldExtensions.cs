...
namespace MG.Posh.Extensions.Shoulds
{
    /// <summary>
    ...
    public static class ShouldExtensions
    {
        ...
        /// </returns>
        public static bool ShouldProcessFormat<T>(this T cmdlet, string action, string target, params object[] targetArguments) where T : PSCmdlet
        {
